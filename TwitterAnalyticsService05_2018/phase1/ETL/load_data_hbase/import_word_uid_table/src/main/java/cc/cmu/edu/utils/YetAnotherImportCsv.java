...
/**
 * Import data file(s) from HDFS to HBase word_uid table.
 *
 * Please note:
...
public class YetAnotherImportCsv {
    ...
    /**
     * The mapper to tokenize the data input with three columns per line.
     *
     * Input format: word \t uid \t hashtag1:score1,(hashtag2:score2,...,hashtagN:scoreN)
     * Output format:
     * K: word,uid V: hashtag1:score1
     * ...
     * K: word,uid V: hashtagN:scoreN
     */
    private static class CsvTokenizerMapper
        ...
        public void map(Object key, Text value, Context context
            ...
            if (columns.length != 3) {
                ...
                String[] hashtags = columns[2].split(",");
    ...
    private static class HBaseTableReducer extends
         ...
         *
         * Input: intermediate KV pairs (K: 'word,uid' V: 'hashtag:score')
