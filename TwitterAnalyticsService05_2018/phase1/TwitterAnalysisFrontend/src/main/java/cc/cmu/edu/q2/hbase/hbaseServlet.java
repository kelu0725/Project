...
public class hbaseServlet extends HttpServlet {
	/*
	 * Add Cache to store request and results
	 */
	...
	public hbaseServlet() throws IOException {
		/*
		 * HBase Connection
		 */
	...
	protected void doGet(final HttpServletRequest request, final HttpServletResponse response)
		...
		String query = keywordString + "&" + userId + "&" + number;
		String cached_result = cache.get(query);
		/*
		 * If cache contains the request, return cache result. Else send query to MySQL
		 * database, add to cache and return result.
		 */
